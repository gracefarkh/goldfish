...
Данный проект был реализован на библиотеки [Create React App](https://github.com/facebook/create-react-app).
...
### Redux/Redux Toolkit:
Стэйт мененджер[https://redux.js.org](https://redux.js.org/)
